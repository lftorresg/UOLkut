            ...
            <section className={classes.container}>
                ...
                <section>
                    <ul className={classes.communityView}>
                        <li>
                            <img src={carro} alt="Carros" />
                            <p>Carros</p>
                        </li>
                        <li>
                            <img src={woody} alt="Desenhos" />
                            <p>Desenhos</p>
                        </li>
                        <li>
                            <img src={bart} alt="Crazy" />
                            <p>Crazy</p>
                        </li>
                        <li>
                            <img src={urso} alt="Fofos" />
                            <p>Fofos</p>
                        </li>
                        <li>
                            <img src={naruto} alt="Animes" />
                            <p>Animes</p>
                        </li>
                        <li>
                            <img src={livro} alt="Leitura" />
                            <p>Leitura</p>
                        </li>
                        <li>
                            <img src={ovo} alt="Meu ovo" />
                            <p>Meu ovo</p>
                        </li>
                        <li>
                            <img src={livro} alt="My books" />
                            <p>My books</p>
                        </li>
                        <li>
                            <img src={cafe} alt="Cafeeee" />
                            <p>Cafeeee</p>
                        </li>
                    </ul>
                </section>
